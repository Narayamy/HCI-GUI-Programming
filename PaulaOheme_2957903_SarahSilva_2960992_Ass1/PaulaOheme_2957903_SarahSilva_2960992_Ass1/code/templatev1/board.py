...
class Board(QFrame):  # base the board on a QFrame widget
    ...
    def initBoard(self):
        ...
        #\ self.setStyleSheet('background-image: url("images/goboard7x7.png")')
    ...
    def drawBoardSquares(self, painter):
        ...
        for row in range(0, Board.boardHeight):
            for col in range(0, Board.boardWidth):
                ...
                painter.drawRect(20, 20, 75, 75)
                #painter.fillRect(QColor(Qt.red))                          # TODO provide the required arguments
                painter.restore()
